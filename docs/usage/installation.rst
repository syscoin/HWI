...
The self-contained binaries are availabe for download from the `releases page <https://github.com/syscoin/HWI/releases>`_.
...
The python packages are distributed both from the `releases page <https://github.com/syscoin/HWI/releases>`_ and from `PyPi <https://pypi.org/project/hwi/>`_.
