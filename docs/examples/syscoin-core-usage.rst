...
This approach is fairly manual, requires the command line, and Syscoin Core >=0.21.0.
...
::
    ...
    $ ../syscoin/src/syscoin-cli -named createwallet wallet_name=hwicoldcard disable_private_keys=true descriptors=true
    {
      "name": "hwicoldcard",
...
::
    ...
    $ src/syscoin-cli -rpcwallet=hwicoldcard getnewaddress
...
This address belongs to your hardware wallet. You can check this by doing ``getaddressinfo``::
    ...
    $ src/syscoin-cli -rpcwallet=hwicoldcard getaddressinfo bc1q2xsn08w749d2tfm7qrkvztlxfmq2564sly4dwl
    {
