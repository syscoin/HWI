...
def ser_compact_size(size: int) -> bytes:
    """
    Serialize an integer using Syscoin's compact size unsigned integer serialization.
...
def deser_string(f: Readable) -> bytes:
    """
    Deserialize a variable length byte string serialized with Syscoin's variable length string serialization from a byte stream.
...
def ser_string(s: bytes) -> bytes:
    """
    Serialize a byte string with Syscoin's variable length string serialization.
...
def deser_uint256(f: Readable) -> int:
    """
    Deserialize a 256 bit integer serialized with Syscoin's 256 bit integer serialization from a byte stream.
...
def ser_uint256(u: int) -> bytes:
    """
    Serialize a 256 bit integer with Syscoin's 256 bit integer serialization.
...
def uint256_from_str(s: bytes) -> int:
    """
    Deserialize a 256 bit integer serialized with Syscoin's 256 bit integer serialization from a byte string.
...
def deser_vector(f: Readable, c: Callable[[], D]) -> List[D]:
    """
    Deserialize a vector of objects with Syscoin's object vector serialization from a byte stream.
...
def ser_vector(v: Sequence[Serializable]) -> bytes:
    """
    Serialize a vector of objects with Syscoin's object vector serialzation.
