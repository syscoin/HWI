...
class LedgerClient(HardwareWalletClient):
    ...
    def __init__(self, path: str, password: str = "", expert: bool = False) -> None:
        ...
        if self.app.getAppName() not in ["Syscoin", "Syscoin Test", "app"]:
            raise UnknownDeviceError("Ledger is not in either the Syscoin or Syscoin Testnet app")
    ...
    def can_sign_taproot(self) -> bool:
        """
        Ledgers support Taproot if the Syscoin App version greater than 2.0.0.
        ...
        if ('interface_number' in d and d['interface_number'] == 0
            ...
            with handle_errors(common_err_msgs["enumerate"], d_data):
                try:
                    ...
                    # This only happens if the ledger is not in the Syscoin app, so skip it
                    continue
