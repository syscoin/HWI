...
class HardwareWalletClient(object):
    ...
    def sign_tx(self, psbt: PSBT) -> PSBT:
        """
        Sign a partially signed syscoin transaction (PSBT).
    ...
    def sign_message(
        ...
        """
        Sign a message (syscoin message signing).

        Signs a message using the legacy Syscoin Core signed message format.
